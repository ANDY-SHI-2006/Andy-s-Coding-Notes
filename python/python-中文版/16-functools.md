[← 上一篇：模块与包](15-模块与包.md) | [下一篇：类型注解 →](17-类型注解.md)
...
## 16.3 使用 `functools.partial` 固定参数
...
## 16.4 使用 `functools.reduce` 归约可迭代对象
...
## 16.5 使用 `@functools.lru_cache` 缓存结果
...
## 16.6 使用 `@functools.total_ordering` 自动生成比较方法
