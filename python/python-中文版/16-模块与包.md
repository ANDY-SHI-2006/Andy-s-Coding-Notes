[← 上一篇：异常处理](15-异常处理.md) | [下一篇：类型注解 →](17-类型注解.md)
...
### 16.2.5 用 `__all__` 控制 `from package import *`
...
更深入的内容（元字符、分组、标志位、实战示例）见 [18 正则表达式（re 模块）](18-正则表达式re.md)。
