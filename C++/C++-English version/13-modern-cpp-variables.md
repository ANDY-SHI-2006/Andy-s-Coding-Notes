[â†?Previous: Advanced Topics](12-advanced-topics.md) | [Next: Data Structures â†’](14-data-structures.md)
...
- Prefer `=` over braces: `auto x = 5;` âœ? `auto x{5};` may have surprises
...
- **Simplify long names**: `std::map<std::string, std::vector<int>>` â†?`StringToIntVectorMap`
...
void example() {
    allocateBuffer(100);        // âœ?WARNING: ignoring nodiscard return value
    auto ptr = allocateBuffer(100);  // âœ?OK: using the result
    delete[] ptr;
}
```
...
Variable Declaration
        â”?        â”œâ”€â”€ Global? â”€â”€â–?Use inline (C++17) or extern + single definition
        â”?        â”œâ”€â”€ Local to function? â”€â”€â–?Automatic storage (default)
        â”?        â”œâ”€â”€ Must persist across calls? â”€â”€â–?static local
        â”?        â”œâ”€â”€ Large / runtime-sized? â”€â”€â–?Dynamic + smart pointer
        â”?        â”œâ”€â”€ Constant value? â”€â”€â–?constexpr (compile-time) or const (runtime)
        â”?        â””â”€â”€ Type is complex? â”€â”€â–?auto or structured binding (C++17)
```
