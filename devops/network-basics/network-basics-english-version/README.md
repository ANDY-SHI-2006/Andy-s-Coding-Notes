# Network Basics English Version

A practical introduction to computer networking fundamentals and socket programming, aimed at developers and DevOps engineers.
...
3. [Sticky Packets and Concurrency](03-sticky-packets-and-concurrency.md) — *sticky packet problem, struct length prefixing, non-blocking sockets, IO multiplexing with select, advanced TCP topics*
